...
namespace RecipePlatform.DAL.Migrations
{
    ...
    [Migration("20250627191515_view and edit recipes")]
    partial class viewandeditrecipes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipePlatform.Models.ApplicationModels.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RecipePlatform.Models.UserModels.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RecipePlatform.Models.ApplicationModels.Rating", b =>
                {
                    ...
                    b.HasOne("RecipePlatform.Models.UserModels.ApplicationUser", "User")
                        .WithMany("Ratings")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RecipePlatform.Models.ApplicationModels.Recipe", b =>
                {
                    b.HasOne("RecipePlatform.Models.UserModels.ApplicationUser", "Author")
                        .WithMany("Recipes")
                        .HasForeignKey("AuthorId");

                    b.HasOne("RecipePlatform.Models.ApplicationModels.Category", "Category")
                        .WithMany("Recipes")
